...
public class tester {
	public static void main(String[] args) {
		...
		Ability sandveil = new SandVeil();
		Ability innerfocus = new InnerFocus();
		Ability oblivious = new Oblivious();
		Ability snowcloak = new SnowCloak();
		Ability steadfast = new Steadfast();
		...
		Pokemon b = new Pokemon("Mamoswine", "Ice/Ground", 59, "Twin Tusk", 217, 190, 131, 100, 98, 128, snowcloak, true, scanner);
		Pokemon c = new Pokemon("Garchomp", "Dragon/Ground", 54, "Mach", 199, 179, 138, 101, 119, 129, sandveil, false, scanner);
		Pokemon k = new Pokemon("Lucario", "Fighting/Steel", 58, "Aura", 344, 202, 130, 211, 130, 141, steadfast, false,scanner);
		...
		Pokemon ga = new Pokemon("Garchomp", "Dragon/Ground", 55, "Mach", 196, 162, 128, 111, 106, 152, sandveil, true, scanner);
		Pokemon luc = new Pokemon("Lucario", "Fighting/Steel", 50, "Aura", 142, 133, 92, 127, 93, 108, innerfocus, false, scanner);
		...
		Pokemon ma = new Pokemon("Piloswine", "Ice/Ground", 55, "Twin Tusk", 187, 141, 103, 95, 84, 104, oblivious, false, scanner);
